    ...
    return (
        <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <div className="bg-amber-50 border border-amber-200/50 rounded-lg p-4 mt-6 flex gap-3">
                ...
                <div>
                    <h4 className="text-[12px] font-semibold text-amber-800">Model Erişim Kısıtlamaları</h4>
                    <p className="text-[11px] text-amber-600/80 mt-0.5">GPT-4 veya pahalı modellerin sadece yetkili Roller tarafından kullanılabilmesi için yeni kurallar tanımlayın.</p>
                </div>
            </div>
        </div>
    );
